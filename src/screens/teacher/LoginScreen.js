...
export default function LoginScreen({ navigation }) {
  ...
  const handleLogin = () => {
    ...
    setTimeout(() => {
      // ID and password are the same as the teacher ID and PIN
      const teacher = TEACHERS.find(
        (t) => t.id.toUpperCase() === cleanId && t.pin === cleanPass
      );

      if (teacher) {
        setLoading(false);
        try {
          navigation.replace('ClassSelection', { teacher });
        } catch (e) {
      ...
      >
        ...
        <View style={styles.navBar}>
          ...
          <View style={styles.roleTag}>
            <Ionicons name="school" size={13} color={COLORS.gold} />
            <Text style={styles.roleTagText}>TEACHER PORTAL</Text>
          </View>
        </View>
        ...
        >
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.signinLabel}>Teacher Sign In</Text>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputBox}>
                ...
                <TextInput
                  ...
                  value={teacherId}
                  onChangeText={(t) => { setTeacherId(t); setError(''); }}
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              Attendance · Meal Prep · Audit Trail
            </Text>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  // Header Band (school name in dark strip)
  headerBand: {
    backgroundColor: COLORS.primaryDark,
